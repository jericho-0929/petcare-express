...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final FoodFormula foodFormula = new FoodFormula();
    ...
    private static final String SQL_CREATE_INVENTORY_TABLE =
            "CREATE TABLE IF NOT EXISTS " + DBContract.FoodTable.TABLE_NAME + " (" +
                    ...
                    ");";
    // Expected behavior for below: Should not fire if there is already a SmartHeart entry.
    public static final String SQL_INSERT_DEFAULT_ROW =
            ...
            "'" + foodFormula.name + "', " +
            "'" + foodFormula.foodType + "', " +
            + foodFormula.minimumPetWeight + ", " +
            + foodFormula.minimumFeedingAmount + ");";
